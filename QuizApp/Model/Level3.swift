...
func makeLevel3() -> [Level3] {
    ...
    //生態
    let Ecology1 = Level3(score: 0, title: "生態1", mark: "")
    let Ecology2 = Level3(score: 0, title: "生態2", mark: "")
    let Ecology3 = Level3(score: 0, title: "生態3", mark: "")
    //暮らし
    let living1 = Level3(score: 0, title: "暮らし1", mark: "")
    let living2 = Level3(score: 0, title: "暮らし2", mark: "")
    let living3 = Level3(score: 0, title: "暮らし3", mark: "")
    //歴史
    let hisitory1 = Level3(score: 0, title: "歴史1", mark: "")
    let hisitory2 = Level3(score: 0, title: "歴史2", mark: "")
    let hisitory3 = Level3(score: 0, title: "歴史3", mark: "")
    //文化
    let culture1 = Level3(score: 0, title: "文化1", mark: "")
    let culture2 = Level3(score: 0, title: "文化2", mark: "")
    let culture3 = Level3(score: 0, title: "文化3", mark: "")
